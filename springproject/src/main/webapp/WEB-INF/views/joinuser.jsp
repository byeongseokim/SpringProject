...
<title>네버 회원가입</title>
<link rel="stylesheet" href="${contextPath}/resources/css/joinuser.css">
<script
...
<body>
	...
	<form action="${contextPath}/user/new.do" method="post" id="form">
		<div class="member">
			<!-- 1. 로고 -->
			<a href="${contextPath}/main/main.do" target="_self" title="네버 홈페이지">
				<img class="logo"
				src="${contextPath}/resources/images/nevermainimage.png" width="250"
				height="70">
			</a>
			<!-- 2. 필드 -->
			<div class="field">
				<b>아이디</b> <span class="placehold-text"> <input
					style="width: auto%" id="id" name="id" type="text"
					placeholder="아이디를 입력해주세요">&nbsp;<input style="width: auto"
					type="button" value="중복 검사" onClick="CheckDup();" class="btnDup">
			...
			<div class="field">
				<b>비밀번호</b> <input name="password" type="password" id="password"
					placeholder="6자리이상의 비밀번호를 입력해주세요" onchange="isSame();"> <input
					type="hidden" id="pwcheckone" value=""> <input
					type="hidden" id="pwchecktwo" value=""> <span id="pid"></span>
			</div>
			<div class="field">
				<b>비밀번호 재확인</b> <input onchange="isSame();" id="repassword"
					type="password" placeholder="비밀번호를 입력해주세요"> <span id="same"></span>
			</div>
			<div class="field">
				<b>이름</b> <input id="name" type="text" name="name"
