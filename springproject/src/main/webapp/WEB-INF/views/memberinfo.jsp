...
<br>
	<div>
		...
		<div class="qjxms">
			...
			<p>
				<label for="pwdname">이름: </label> <input type="text" id="pwdname"
					...
					</p><p> <label for="pwdid">아이디: </label> <input
					type="text" id="pwdid" placeholder="아이디를 입력해주세요">
		...
		<button id="id_btn" style="display: none" type="button" onclick="searciddb()">
		아이디찾기
		
		</button>
		<button id="pwd_btn" style="display: none" type="button" onclick="searcpwddb()">
			비밀번호찾기</button>
	</div>
<script>
