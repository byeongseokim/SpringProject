...
<body>
	<form action="../board/add.do" method="post">
		<input style="width: 46%" type="text" name="btie" placeholder="제목">
		<input style="width: 20%" type="text" name="bwriter" id="id"
			readonly="readonly" value="작성자"> <select name="cate" id="1"
			style="width: 32%">
